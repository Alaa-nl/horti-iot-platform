          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-2">Advanced data visualization and insights</p>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <select
                  ...
                  className="px-4 py-2 rounded-xl border border-gray-200 bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-gray-800">Environmental Trends Analysis</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
              >
                <h3 className="text-lg font-bold text-gray-800 mb-4">Crop Performance Analysis</h3>
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
              >
                <h3 className="text-lg font-bold text-gray-800 mb-4">Resource Optimization</h3>
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={resourceData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
                    <XAxis dataKey="resource" tick={{ fill: '#6B7280' }} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
              >
                <h3 className="text-lg font-bold text-gray-800 mb-4">Yield Prediction Model</h3>
              ...
              <motion.div
                ...
                className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
              >
                <h3 className="text-lg font-bold text-gray-800 mb-4">Temperature vs Yield Correlation</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <ScatterChart data={correlationData}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
                    <XAxis type="number" dataKey="temperature" name="Temperature (°C)" tick={{ fill: '#6B7280' }} />
                    <YAxis type="number" dataKey="yield" name="Yield" tick={{ fill: '#6B7280' }} />
                ...
                <div className="mt-4 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div>
                      <p className="text-gray-600">Optimal Temperature</p>
            ...
            <motion.section
              ...
              className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
            >
              <h2 className="text-xl font-bold text-gray-800 mb-6">Device Network Performance</h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">

                {/* Device Status Over Time */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-700 mb-4">Weekly Device Status</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-700 mb-4">Network Health Metrics</h3>
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-gray-600">Data Transmission Rate</span>
            ...
            <motion.section
              ...
              className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6"
            >
              <h2 className="text-xl font-bold text-gray-800 mb-6">Cost-Benefit Analysis</h2>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-violet-100 border border-purple-200">
                  ...
                  <p className="text-xs text-gray-500 mt-2">18 month payback</p>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-yellow-100 border border-orange-200">
                  ...
                  <p className="text-sm text-gray-600 mb-2">Yield Increase</p>
