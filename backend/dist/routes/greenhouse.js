...
const createGreenhouseSchema = joi_1.default.object({
    ...
    dimensions: joi_1.default.object().optional().allow(null),
    area_m2: joi_1.default.number().positive().optional().allow(null),
    crop_type: joi_1.default.string().max(100).optional().allow('', null),
    variety: joi_1.default.string().max(100).optional().allow('', null),
    rootstock: joi_1.default.string().max(100).optional().allow('', null),
    planting_date: joi_1.default.date().optional().allow(null),
    supplier: joi_1.default.string().max(255).optional().allow('', null),
    substrate_info: joi_1.default.string().max(500).optional().allow('', null),
    climate_system: joi_1.default.string().max(255).optional().allow('', null),
    lighting_system: joi_1.default.string().max(255).optional().allow('', null),
    growing_system: joi_1.default.string().max(255).optional().allow('', null),
    co2_target_ppm: joi_1.default.number().positive().optional().allow(null),
    temperature_range_c: joi_1.default.string().max(50).optional().allow('', null),
    configuration: joi_1.default.object().optional().allow(null)
});
